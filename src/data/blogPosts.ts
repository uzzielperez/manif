...
export const BLOG_POSTS: BlogPost[] = [
  ...
  {
    slug: 'no-villain-drive-all-blames-into-one-lojong-mind-training',
    title: 'No Villain: Drive All Blames Into One — Lojong Mind Training',
    date: 'Mar 18, 2026',
    category: 'Philosophy',
    excerpt:
      "Lojong’s “Drive all blames into one” turns pain into self-authorship—the foundation of real manifestation.",
    content: [
      { type: 'blockquote', text: 'Drive all blames into one.' },
      { type: 'p', text: 'Not into them. Not into circumstance. Not into bad timing or the wrong city or the person who left or the one who stayed too long. Into one. Into the self. Into the pattern that chose, accepted, repeated, avoided — into the part of you that was present for all of it.' },
      { type: 'p', text: "Most people hear this and flinch. It sounds like cruelty dressed up in spiritual language. But practiced rightly, it is the opposite. It is the most liberating thing you can do with your pain." },
      { type: 'p', text: 'And it is, as it turns out, the foundation of real manifestation.' },
      { type: 'h2', text: 'What the Slogan Actually Means' },
      { type: 'p', text: 'Lojong — mind training — is a set of 59 slogans developed in Tibet as daily contemplative practices. They are not gentle. They are designed to disrupt the ego’s favorite stories, and “Drive all blames into one” is among the most radical.' },
      { type: 'p', text: 'The instruction is this: when something goes wrong — when you feel hurt, betrayed, disappointed, abandoned — resist the reflex to locate the source of pain outside yourself.' },
      { type: 'p', text: 'Not because the other person is blameless. Not because context doesn’t matter. But because the moment you make someone else the villain of your story, you have also made yourself the victim. And victims cannot create.' },
      { type: 'p', text: 'The moment you assign the villain, you surrender the pen.' },
      { type: 'p', text: 'The practice does not say: pretend nothing happened. It does not say: swallow your hurt. It says: bring the gaze back. Ask what in you chose this, tolerated this, misread this, needed this.' },
      { type: 'p', text: 'Ask what this situation is revealing about the interior — about the patterns so old and familiar you stopped calling them patterns and started calling them just the way things are.' },
      { type: 'p', text: 'This is not self-punishment. This is self-authorship.' },
      { type: 'h2', text: 'The Villainization Trap' },
      { type: 'p', text: 'It feels good to have a villain. There’s a relief in it — a sudden clarity that dissolves ambiguity and gives shape to pain. It was them. It was that. If only that hadn’t happened.' },
      { type: 'p', text: 'But notice what the villain story costs you. Every scene you replay in which they were wrong cements you as powerless in it.' },
      { type: 'p', text: 'Every grievance you polish removes you one step further from the present, from agency, from the open field where new things might arrive.' },
      { type: 'p', text: 'The mind in blame is a closed system. It is recycling the same evidence, reaching the same verdict, confirming the same wound. Nothing new can enter. Nothing new can be built. You are perfectly right and perfectly stuck.' },
      { type: 'p', text: 'You cannot manifest from a courtroom. You can only manifest from a field.' },
      { type: 'p', text: 'This is why the slogan is not just a spiritual exercise — it is a practical one. The neuroscience agrees: rumination, which is just blame with nowhere to go, activates the brain’s threat systems and suppresses the prefrontal cortex — the very part responsible for creative thinking, future planning, and the ability to imagine alternatives.' },
      { type: 'p', text: 'You are literally less capable of envisioning a new life when you are rehearsing an old grievance.' },
      { type: 'h2', text: 'The Self as the Only Lever' },
      { type: 'p', text: 'Here is the uncomfortable geometry of this practice: you can only change what you own. You cannot edit someone else’s chapter. You cannot revise their choices or rewrite their nature or force the version of them you needed into existence.' },
      { type: 'p', text: 'But you can own your chapter entirely. Every line of it. And in owning it, you get to rewrite what comes next.' },
      { type: 'p', text: 'Radical responsibility is not self-blame. It is self-retrieval.' },
      { type: 'p', text: 'When you drive all blames into one — into yourself, into your pattern, into your unconscious agreements — you are not condemning yourself. You are reclaiming every ounce of energy you had invested in changing what was never yours to change.' },
      { type: 'p', text: 'That energy comes home. And it is enormous.' },
      { type: 'p', text: 'People who do this work describe it as a sudden, disorienting expansion. Like being freed from a weight they had normalized. Like discovering they had been pushing against a locked door for years, and the key was inside them the whole time.' },
      { type: 'h2', text: 'Why This Is a Manifestation Practice' },
      { type: 'p', text: 'Real manifestation — not the performance of it, not the affirmation theater, but the genuine restructuring of what you attract and create — requires one thing above everything else: coherence between what you say you want and what you actually believe you deserve.' },
      { type: 'p', text: 'Most people have a gap there. A wide one. They want love but believe at some level they are fundamentally difficult to love. They want abundance but carry a bone-deep story that security always gets taken away. They want partnership but secretly expect to be let down.' },
      { type: 'p', text: 'And here is what the villain story does to that gap: it makes it permanent. Because if it was always them — if the ex was just toxic, if the boss was just threatened, if circumstances were just against you — then you don’t have to look at the belief underneath. You don’t have to ask what you were drawing, or why, or what part of you recognized that dynamic as familiar and called it home.' },
      { type: 'p', text: 'You cannot outmanifest a story you refuse to examine.' },
      { type: 'p', text: 'But when you drive all blames into one — when you sit with the discomfort of your own participation — something remarkable happens. The belief surfaces. The wound becomes visible. And visible wounds can be tended. Visible patterns can be interrupted. Conscious structures can be consciously rebuilt.' },
      { type: 'p', text: 'This is why the Lojong masters would say this slogan is not punishment — it is the beginning of actual freedom.' },
      { type: 'h2', text: 'The Practice' },
      { type: 'p', text: 'You do not do this once. You do this every time the story wants a villain.' },
      { type: 'p', text: 'Someone disappoints you. The blame reflex fires — fast, hot, convincing. And you pause. Not to suppress it. Not to pretend you are not hurt. But to turn gently toward the interior and ask: What did I not see? What did I not say? What did I choose, and why? What am I supposed to understand about myself through this?' },
      { type: 'p', text: 'You are not asking these questions to destroy yourself. You are asking them the way a good editor asks questions — with love for the work, and a commitment to making it truer.' },
      { type: 'p', text: 'The question is not who did this to you. The question is what you are going to do with it.' },
      { type: 'p', text: 'Over time, this practice changes the quality of your attention. You stop scanning relationships for danger and start scanning them for information. You stop reacting from wound and start responding from awareness. And slowly, almost imperceptibly, the kinds of situations you find yourself in begin to change — because the being who creates them has changed.' },
      { type: 'p', text: 'That is manifestation. Not magic. Not performance. Not commanding the universe. The quiet, relentless work of becoming someone whose inner world can hold something different.' },
      { type: 'h2', text: 'A Note on Compassion' },
      { type: 'p', text: 'None of this erases what others did. People cause genuine harm. Relationships can be genuinely unjust.' },
      { type: 'p', text: 'This practice is not an instruction to minimize that or to stay somewhere you should leave, or to forgive on a timeline that isn’t yours.' },
      { type: 'p', text: 'It is an instruction about where to put your attention after. After you’ve felt it, after you’ve honored the hurt, after you’ve been honest about what happened — where do you look?' },
      { type: 'p', text: 'You look inward. Not to assign guilt. But to retrieve the lesson, reclaim the energy, and return to yourself as the author of what comes next.' },
      { type: 'p', text: 'The other person gets to be a human being — complicated, limited, doing their best or not doing their best, as people do. They do not need to be a villain in your story for your pain to be real. And you do not need to be a victim for your loss to matter.' },
      { type: 'p', text: 'You can hold both. This hurt, and it was also mine to learn from.' },
      { type: 'blockquote', text: 'There is no villain. There is only the next version of you being forged in the fire of everything that came before.' },
    ],
  },
];
